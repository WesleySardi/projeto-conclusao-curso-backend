...
@JsonPropertyOrder({"titulo", "mensagem", "cpfResponsavel", "dataEnvio", "lida"})
public class NotificationStorageCommand implements Serializable {
    ...
    public NotificationStorageCommand(String titulo, String mensagem, String cpfResponsavel, ZonedDateTime dataEnvio, Boolean lida) {
        this.titulo = titulo;
