...
public class SmsHandlerDTO extends RepresentationModel<SmsHandlerDTO> implements Serializable {
    ...
    public SmsHandlerDTO() {
    }

    public SmsHandlerDTO(int i, String s, String s1, String s2, String s3) {
    }

    public SmsHandlerDTO(int smsCode, Timestamp sendDate, Timestamp returnDate, String phoneUser, String cpfDep) {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SmsHandlerDTO vo)) return false;
